...
const SITE_COPY = {
  ...
  features: {
    ...
    h1: "Every module, and what it actually does.",
    lede:
      "Fourteen modules across preparation, screening, simulation, and design — with the tools behind each one, what goes in, what comes out, and whether it needs a Pro license.",
    seo: {
